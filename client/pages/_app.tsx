...
export const NEXT_PUBLIC_INFRASTRUCTURE_INDIGENOUS_PROJECT =
  publicRuntimeConfig.NEXT_PUBLIC_INFRASTRUCTURE_INDIGENOUS_PROJECT;
export const NEXT_PUBLIC_NETWORK_PROJECT = publicRuntimeConfig.NEXT_PUBLIC_NETWORK_PROJECT;
export const NEXT_PUBLIC_NETWORK_INDIGENOUS_PROJECT = publicRuntimeConfig.NEXT_PUBLIC_NETWORK_INDIGENOUS_PROJECT;
